    ...
    () => {
      ...
      writeFileSync(
        ...
        [
          ...
          "void matching;",
          "void wrong;",
          "type Rejected = RejectAny | RejectUnknown | RejectErasedViewport | RejectStringIndex | RejectPatternIndex | RejectUnsafeUnion | RejectMixedViewportUnion | RejectIntersectedViewports | RejectEquivalentViewportUnion | RejectNonInvariantWitness | RejectUnwitnessed;",
          "",
        ].join("\n"),
      );
    ...
    () => {
      ...
      writeFileSync(
        ...
        [
          ...
          "type ClientRejection = StringIndex | PatternIndex | UnsafeUnion | MixedWitnessUnion | IntersectedWitnesses | EquivalentWitnessUnion | NonInvariantWitness | Unwitnessed;",
          "",
        ].join("\n"),
      );
