...
implemented by issue #384, and first-party gRPC adoption is implemented by
issue #386. First-party Kafka adoption and the final canonical-only
configuration cut remain staged in issues #385 and #387.
