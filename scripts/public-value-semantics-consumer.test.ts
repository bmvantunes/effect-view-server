...

    {
      ...
      writeFileSync(
        ...
        [
          ...
          'import { compareTrustedWireSafeBigDecimal, inspectWireSafeBigDecimal, type WireSafeBigDecimal, type WireSafeBigDecimalInspection } from "effect-view-server/value-semantics";',
