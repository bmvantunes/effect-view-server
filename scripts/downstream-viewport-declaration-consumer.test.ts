    ...
    () => {
      ...
      writeFileSync(
        ...
        [
          ...
          "void matching;",
          "void wrong;",
          "type Rejected = RejectAny | RejectUnknown | RejectErasedViewport | RejectStringIndex | RejectPatternIndex | RejectUnsafeUnion | RejectUnwitnessed;",
          "",
        ].join("\n"),
      );
    ...
    () => {
      ...
      writeFileSync(
        ...
        [
          ...
          "type ClientRejection = StringIndex | PatternIndex | UnsafeUnion | Unwitnessed;",
          "",
        ].join("\n"),
      );
