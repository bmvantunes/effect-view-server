    ...
    () => {
      ...
      writeFileSync(
        ...
        [
          ...
          "void matching;",
          "void wrong;",
          "type Rejected = RejectAny | RejectUnknown | RejectErasedViewport | RejectStringIndex | RejectPatternIndex | RejectUnsafeUnion | RejectMixedViewportUnion | RejectUnwitnessed;",
          "",
        ].join("\n"),
      );
    ...
    () => {
      ...
      writeFileSync(
        ...
        [
          ...
          "type ClientRejection = StringIndex | PatternIndex | UnsafeUnion | MixedWitnessUnion | Unwitnessed;",
          "",
        ].join("\n"),
      );
