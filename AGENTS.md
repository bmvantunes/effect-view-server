...
5 - wait for all external PR reviewers: Codex Cloud, CodeRabbit, Cubic (`@cubic-dev-ai`), and Sourcery (`@sourcery-ai`).
6 - if any of Codex Cloud, CodeRabbit, Cubic, or Sourcery reports issues, fix them, commit/push, and return to step 1.
...
- Do not merge while any external PR review is pending: Codex Cloud, CodeRabbit, Cubic (`@cubic-dev-ai`), or Sourcery (`@sourcery-ai`). Address actionable feedback from all four reviewers and wait for all four to report clean.
