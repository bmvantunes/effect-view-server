    ...
    () => {
      ...
      writeFileSync(
        ...
        [
          ...
          "void matching;",
          "void wrong;",
          "type Rejected = RejectAny | RejectUnknown | RejectErasedViewport | RejectStringIndex | RejectPatternIndex | RejectUnwitnessed;",
          "",
        ].join("\n"),
      );
    ...
    () => {
      ...
      writeFileSync(
        ...
        [
          ...
          "type ClientRejection = StringIndex | PatternIndex | Unwitnessed;",
          "",
        ].join("\n"),
      );
